...
from users import login, logout  # Importujemy funkcje logowania i wylogowywania
from data import load_data, save_data  # Importujemy funkcje ładowania i zapisywania danych
from charts import show_charts  # Importujemy funkcję do generowania wykresów
...
if menu == 'Production Charts':
    show_charts(df)  # Wywołanie funkcji z charts.py do generowania wykresów
